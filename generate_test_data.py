...
def run_simulation():
    ...
    test_signals = [
        ...
        {"content": "Designing a scalable microservices architecture for the nebula cloud", "signal_type": "Work", "priority": "high", "duration": 60},
        {"content": "Implementing asynchronous message processing logic", "signal_type": "Work", "priority": "medium", "duration": 45},
        {"content": "Writing unit tests for the core physics engine", "signal_type": "Work", "priority": "low", "duration": 30},
        
        # --- Stage 2: Sudden Shift (Fitness) ---
        # With high inertia, these signals should only slowly pull the global identity
        {"content": "Deadlifting heavy at the gym and pushing personal limits", "signal_type": "Health", "priority": "high", "duration": 50},
        {"content": "Sprinting and anaerobic interval training session", "signal_type": "Health", "priority": "medium", "duration": 40},
        
        # --- Stage 3: Culinary Exploration ---
        {"content": "Baking professional-grade sourdough with hydrated dough", "signal_type": "Work", "priority": "medium", "duration": 120}
    ]
